...
Installing pymt_rafem from the `conda-forge` channel can be achieved by adding
...
To install pymt_rafem, run this command in your terminal:

.. code-block:: console

    $ conda install pymt_rafem

This is the preferred method to install pymt_rafem, as it will always install the most recent stable release.
...
The sources for pymt_rafem can be downloaded from the `Github repo`_.
